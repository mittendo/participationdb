<div class="energySectors index">
	<h2><?php echo __('Energy Sectors'); ?></h2>
	...
	<tr>
		<td><?php echo h($energySector['EnergySector']['id']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $energySector['EnergySector']['id']), null, __('Are you sure you want to delete # %s?', $energySector['EnergySector']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
