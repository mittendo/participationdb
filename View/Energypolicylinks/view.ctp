<div class="energypolicylinks view">
<h2><?php  echo __('Energypolicylink'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($energypolicylink['Energypolicylink']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($energypolicylink['Energypolicylink']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($energypolicylink['Energypolicylink']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($energypolicylink['Energypolicylink']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Number'); ?></dt>
		<dd>
			<?php echo h($energypolicylink['Energypolicylink']['number']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Energypolicylink'), array('action' => 'edit', $energypolicylink['Energypolicylink']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Energypolicylink'), array('action' => 'delete', $energypolicylink['Energypolicylink']['id']), null, __('Are you sure you want to delete # %s?', $energypolicylink['Energypolicylink']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($energypolicylink['Realisation'])): ?>
	...
	<?php
		$i = 0;
		foreach ($energypolicylink['Realisation'] as $realisation): ?>
		<tr>
