...
<?php echo $this->Form->create('Energypolicylink'); ?>
	<fieldset>
		<legend><?php echo __('Edit Energypolicylink'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Energypolicylink.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Energypolicylink.id'))); ?></li>
