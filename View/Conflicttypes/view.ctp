<div class="conflicttypes view">
<h2><?php  echo __('Conflicttype'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($conflicttype['Conflicttype']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($conflicttype['Conflicttype']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($conflicttype['Conflicttype']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($conflicttype['Conflicttype']['modified']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Categorycol'); ?></dt>
		<dd>
			<?php echo h($conflicttype['Conflicttype']['categorycol']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Conflicttype'), array('action' => 'edit', $conflicttype['Conflicttype']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Conflicttype'), array('action' => 'delete', $conflicttype['Conflicttype']['id']), null, __('Are you sure you want to delete # %s?', $conflicttype['Conflicttype']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($conflicttype['Realisation'])): ?>
	...
	<?php
		$i = 0;
		foreach ($conflicttype['Realisation'] as $realisation): ?>
		<tr>
