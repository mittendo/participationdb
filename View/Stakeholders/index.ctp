<div class="stakeholders index">
	<h2><?php echo __('Stakeholders'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $stakeholder['Stakeholder']['id']), null, __('Are you sure you want to delete # %s?', $stakeholder['Stakeholder']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
