<div class="processcomponents index">
	<h2><?php echo __('Processcomponents'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($processcomponent['Processcomponent']['number']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $processcomponent['Processcomponent']['id']), null, __('Are you sure you want to delete # %s?', $processcomponent['Processcomponent']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
